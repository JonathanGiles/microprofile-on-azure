...
This sample makes use of a free and open source library that creats a config source (using the MicroProfile Config API) for Azure Key Vault. You can learn more about this library, and review the code, on the [azure-key-vault-microprofile-config-source](https://github.com/JonathanGiles/azure-key-vault-microprofile-config-source) GitHub page. By using this library, the code in this tutorial can simply focus on configuration of the library, followed by injecting keys into your code, and we don't need to write any Azure-specific code.
...
This sample application bakes together the MicroProfile Config API, Azure Key Vault, and the free and open source [azure-key-vault-microprofile-config-source](https://github.com/JonathanGiles/azure-key-vault-microprofile-config-source) library to enable easy injection of configuration data and secrets into our MicroProfile web services.

## Links

* Learn how to dockerize your MicroProfile application in my '[Deploy a Java-based MicroProfile service to Azure Web App for Containers](https://github.com/JonathanGiles/microprofile-on-azure/tree/master/docker-helloworld)' tutorial.